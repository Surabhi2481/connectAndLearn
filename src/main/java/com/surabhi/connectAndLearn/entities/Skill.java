...
public class Skill extends AbstractEntity{
	...
	public String toString() {
		return "Skill [name=" + name + ", description=" + description + ", instructorId=" + instructorId
				+ ", instructorName=" + instructorName + ", fee=" + fee + ", rating=" + rating + ", studentsSoFar="
				+ studentsSoFar + ", usersRated=" + usersRated + "]";
	}
