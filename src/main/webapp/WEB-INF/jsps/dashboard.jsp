...
.skillcard a:hover {
	color: #fff !important;
	background-color: #6CC8CC !important;
}
...
.myskill {
	border-radius: 16px;
	background: #dfdddd;
	box-shadow: 10px 10px 21px #bebcbc, -10px -10px 21px #fffefe;
	padding: 20px 20px;
	font-family: Montserrat, sans-serif;
	font-weight: bold;
}
...
<body id="myPage" data-spy="scroll" data-target=".navbar"
	...
	<nav class="navbar navbar-default navbar-fixed-top">
		<div class="container">
			<div class="navbar-header">
				...
				<a class="navbar-brand" href="#myPage">Connect-And-Learn</a>
			</div>
	...
	<div class="utilityoptions">
		<a href="showLearn"><div class="utilityelement">Learn a new
				hobby !</div></a> <a href="showTeach"><div class="utilityelement">Teach
				a new hobby !</div></a> <a href="showEnrollments"><div
				class="utilityelement">My Enrollments</div></a> <a href="showTrainees"><div
				class="utilityelement">My Trainees</div></a> <a href="showCourses"><div
				class="utilityelement">My Courses</div></a>
	</div>
</body>
</html>
